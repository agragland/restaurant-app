                ...
                <form className="signin-form">
                    <div className='form-inner'>
                        ...
                        <div className='form-group'>
                            ...
                            <input type="text" placeholder="4-digit Password here" value={exitPassword} onChange={handleExitPassword()} />
                        </div>
                        <div>
            ...
            <form className="signin-form">
                <div className='form-inner'>
                    ...
                    <div className='form-group'>
                        ...
                        <input type="text" placeholder="4-digit Password here" value={parentPassword} onChange={handleParentPassword()} />
                    </div>
                    <div>
